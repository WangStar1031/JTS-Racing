<?php
	...
	while(true) {
		...
		$result = check_race_time_change2();
		foreach ($result as $event_obj) {
			...
			if($event_obj->type == "time") {			
				...
				__api_send2__("http://staging.dw.xtradeiom.com/api/meetings", "POST", $event, "jra2_time");
				...
				__api_send2__("http://staging.dw.xtradeiom.com/api/meetings", "POST", $event, "jra2_".$event_type, $log_event);
			}
		}
		sleep(5);
	}	
