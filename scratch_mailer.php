			...
			<head>
				...
				<style>
					*{font-size: 16px; font-family: Arial;}
					...
					.mail_content{ line-height: 3rem; font-size:1.1rem; padding: 15px; font-family: Arial; color: #11285d; font-weight: bold;}
					.mail_background {
						opacity:0.3;
						top: 0;
					    left: 0;
...
( This is an automated Email )';
		...
		if($mail_check) {
			$emails = [ "mark.oriend.philip@outlook.com", "cg@jts.ec", "gerardl@globalbettingservices.com", "lee.sinclair@betia.co", "AustralianRacingDeskIndividual@bet365.com", "AustralianControl.DeskMailbox@bet365.com", "Stuart.Springer@bet365.com" ];
			// $emails = [ "mark.oriend.philip@outlook.com", "cg@jts.ec", "gerardl@globalbettingservices.com", "lee.sinclair@betia.co", "AustralianRacingDeskIndividual@bet365.com", "AustralianControl.DeskMailbox@bet365.com", "ControlDesk.Mailbox@bet365.com", "Stuart.Springer@bet365.com" ];
