...
// echo "__get_schedule_data";
// echo $date_str . "<br>";
  if($date_str == "") {
    $now_time = GetCurrentJapanTime();
    $date_str = date("Y/n/md", strtotime($now_time));
  }
  // $date_str = substr($date_str, 0,4) . 
  // $date_str = date("Y/n/md", $date_str);
$str_date = $date_str;
$str_Year = substr($str_date, 0, 4);
$str_Month = substr($str_date, 4, 2);
$str_Day = substr($str_date, 6, 2);
$ret_Date = $str_Year . "/" . (int)$str_Month . "/" . $str_Month . $str_Day;
$date_str = $ret_Date;
// echo $ret_Date;

// echo "http://www.jra.go.jp/keiba/calendar/".$date_str.".html" . "<br>";
...
// echo "No File" . "<br>";
  $arr_meetings = __get_meeting_ids($proc_date);
print_r($arr_meetings);
// echo "<br>";
  $str_html = __get_schedule_data($proc_date);
// echo $str_html . "<br>";
  $race_name = "";
